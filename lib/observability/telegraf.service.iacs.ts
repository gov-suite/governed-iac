...
import { polyglotArtfNature } from "../../deps.ts";
...
export class TelegrafPluginServiceDockerfile implements Instructions {
  readonly isInstructions = true;

  constructor(
    readonly options?: TelegrafOptions,
    readonly scOptionals?: ServiceConfigOptionals,
  ) {}
...
export class TelegrafPluginServiceConfig extends TypicalImmutableServiceConfig {
  ...
  readonly initOsqueryLogVolume: ServiceVolumeLocalFsPathConfig;
