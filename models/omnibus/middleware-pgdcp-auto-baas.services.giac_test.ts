...
import * as iacModel from "./middleware-pgdcp-auto-baas.services.giac.ts";

Deno.test(
  "middleware-pgdcp-auto-baas-graph Dockerfile and docker-compose.yaml Transformer",
  () => {
